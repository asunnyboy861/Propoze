...
struct PaywallView: View {
    ...
    private var featureComparison: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            featureRow("AI assistance", isPro: true)
        }
        .padding()
    ...
    private var planPicker: some View {
        HStack(spacing: 12) {
            planCard("Monthly", price: "$9.99/mo", id: "monthly")
            planCard("Yearly", price: "$79.99/yr", id: "yearly", badge: "33% OFF")
            planCard("Lifetime", price: "$149.99", id: "lifetime", badge: "Best Value")
        }
    }
